                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="text-base text-gray-60 mb-1">{{$vacante->empresa}}</p>
                            <p class="text-xs font-bold text-gray-60 mb-1">{{$vacante->categoria->categoria}}</p>
                            <p class="text-base text-gray-60 mb-1">{{$vacante->salario->salario}}</p>
